...
By default, tokens are loaded from a local copy ([`salt-ds.ts`](https://github.com/origami-z/salt-ds-tokens/blob/salt-tokens/docs/visualizer/src/controllers/salt-data.ts)).

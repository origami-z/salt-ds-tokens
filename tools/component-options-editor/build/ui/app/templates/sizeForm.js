...
let SizeForm = class SizeForm extends LitElement {
  constructor() {
    super(...arguments);
    this.values = ["s", "m", "l", "xl"];
    this.defaultValue = "m";
  }
  removeSize(index) {
...
`;
__decorate([property({ type: Array })], SizeForm.prototype, "values", void 0);
__decorate(
...
SizeForm = __decorate([customElement("size-form")], SizeForm);
export default SizeForm;
//# sourceMappingURL=sizeForm.js.map
